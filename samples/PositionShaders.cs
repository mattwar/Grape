...
window.Rendering += (w, r) =>
{
    ...
    r.DrawMesh(staticTopLeft, Shaders.Position);
    ...
    r.DrawMesh(triangle, Shaders.PositionWithTransform, topRight);
    ...
    r.DrawMesh(triangle, Shaders.PositionWithTransformAndColor, new TransformAndColorArgs
    {
        Mvp = bottomLeft,
