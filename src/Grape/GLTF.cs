...
/// factor, and base-color texture into Grape's
...
internal static class GLTF
{
    public static Model Load(string path)
    {
        ...
        // Cache: glTF Image -> Grape Image, so two materials sharing a
    ...
    {
        // glTF colors are linear-space floats 0..1. Grape's Color is
        // sRGB byte. We pass the float values through directly --
        // Grape's pipeline doesn't currently do gamma correction, so
