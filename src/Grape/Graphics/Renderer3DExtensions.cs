...
public static class Renderer3DExtensions
{
    ...
    /// <summary>Renders a position-only mesh.</summary>
    public static void RenderMesh(this Renderer3D renderer, Mesh<Vertex3D> mesh)
    {
        ArgumentNullException.ThrowIfNull(renderer);
        renderer.RenderMesh(mesh, Shaders.Position);
    }

    /// <summary>Renders a position-only mesh with the given position transform.</summary>
    ...
    public static void RenderMesh(this Renderer3D renderer, Mesh<ColorVertex3D> mesh)
    {
        ArgumentNullException.ThrowIfNull(renderer);
        renderer.RenderMesh(mesh, Shaders.PositionColor);
    }

    /// <summary>Renders a position &amp; color mesh with the given position transform.</summary>
    ...
    public static void RenderMesh(this Renderer3D renderer, Mesh<TextureVertex3D> mesh, Image texture)
    {
        ArgumentNullException.ThrowIfNull(renderer);
        renderer.RenderMesh(mesh, texture, Shaders.PositionTexture);
    }

    /// <summary>Renders a position &amp; texture mesh with the given texture and position transform.</summary>
    ...
    /// </summary>
    public static void RenderMesh<TVertex>(
    ...
    /// </summary>
    public static void RenderMesh<TVertex, TArgs>(
        this Renderer3D renderer,
        TVertex[] vertices,
        ...
        where TArgs : unmanaged
    {
        ...
        var mesh = renderer.GetOrCreateMesh(vertices, count);
        renderer.RenderMesh(mesh, shader, in args);
    }
        ...
        where TVertex : unmanaged
    {
        ...
        var mesh = renderer.GetOrCreateMesh(vertices, count);
        renderer.RenderMesh(mesh, texture, shader);
    }
        ...
        where TArgs : unmanaged
    {
        ...
        var mesh = renderer.GetOrCreateMesh(vertices, count);
        renderer.RenderMesh(mesh, texture, shader, in args);
    }
    ...
    /// <summary>Renders a position-only mesh from an array.</summary>
    public static void RenderMesh(this Renderer3D renderer, Vertex3D[] vertices, int? vertexCount = null)
        => renderer.RenderMesh(vertices, Shaders.Position, vertexCount);
    ...
    public static void RenderMesh(this Renderer3D renderer, ColorVertex3D[] vertices, int? vertexCount = null)
        => renderer.RenderMesh(vertices, Shaders.PositionColor, vertexCount);
    ...
    public static void RenderMesh(this Renderer3D renderer, TextureVertex3D[] vertices, Image texture, int? vertexCount = null)
        => renderer.RenderMesh(vertices, texture, Shaders.PositionTexture, vertexCount);
    ...
    /// <summary>Renders a position-only mesh from an immutable array.</summary>
    public static void RenderMesh(this Renderer3D renderer, ImmutableArray<Vertex3D> vertices)
        => renderer.RenderMesh(vertices, Shaders.Position);
    ...
    public static void RenderMesh(this Renderer3D renderer, ImmutableArray<ColorVertex3D> vertices)
        => renderer.RenderMesh(vertices, Shaders.PositionColor);
    ...
    public static void RenderMesh(this Renderer3D renderer, ImmutableArray<TextureVertex3D> vertices, Image texture)
        => renderer.RenderMesh(vertices, texture, Shaders.PositionTexture);
