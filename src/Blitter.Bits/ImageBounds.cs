...
public static class ImageBounds
{
    ...
    /// </summary>
    public static BoundingRect ComputeOpaqueBounds(this BitmapImage image, byte alphaThreshold = 0)
    {
    ...
    /// </summary>
    public static BoundingCircle ComputeOpaqueCircle(this BitmapImage image, byte alphaThreshold = 0) =>
