...
public static class WindowExtensions
{
    ...
    /// </summary>
    public static Texture CreateTexture(this Window2D window, int width, int height, SDL.PixelFormat? format = null, SDL.TextureAccess access = SDL.TextureAccess.Streaming)
    {
    ...
    /// </summary>
    public static Texture CreateTexture(this Window2D window)
    {
    ...
    /// </summary>
    public static Texture CreateTexture(this Window2D window, Surface surface)
    {
