...
public static class SkiaSharpExtensions
{
    extension(Image image)
    {
        ...
        /// </param>
        /// <param name="renderAction">Callback that issues canvas draws.</param>
        public void RenderCanvas(Blitter.Color backgroundColor, Action<SKCanvas> renderAction)
    ...
    private static void RenderCanvasCore(Image image, Blitter.Color? backgroundColor, Action<SKCanvas> renderAction)
    {
